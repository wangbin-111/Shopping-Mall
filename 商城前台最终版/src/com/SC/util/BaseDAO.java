...
public class BaseDAO {
    ...
    //Dept d = dao.get(new Dept(60),"deptno");
    /**
     * 查询单行数据
     * @param obj
     * @param pkname
    ...
    //ArrayList<Dept> list = dao.list(Dept.class);
...
//根据属性查找
    public ArrayList listType(Class c,String pk,Object pkzhi){
        //sql拼接
        //创建StringBuffer对象
        StringBuffer sql = new StringBuffer();
        //根据类名获取对应的表名
        ...
        sql.deleteCharAt(sql.length()-1);
        sql.append(" from "+tableName+" where "+pk+"="+pkzhi);
     ...
     * @return
     */
    public ArrayList list2(Class c,String pkzhi,String pk,int page,int size){
        //sql拼接
        //创建StringBuffer对象
        StringBuffer sql = new StringBuffer();
        //根据类名获取对应的表名
        ...
        sql.deleteCharAt(sql.length()-1);
        sql.append(" from " +tableName+" where("+pk+"="+pkzhi+")"+" limit ?,?");
     ...
     * @return
     */
    public ArrayList keyWord(Class c,String keyword){
        //sql拼接
        //创建StringBuffer对象
        StringBuffer sql = new StringBuffer();
        //根据类名获取对应的表名
        ...
        sql.deleteCharAt(sql.length()-1);
        sql.append(" from "+tableName+" where g_name like '%"+keyword+"%'");
