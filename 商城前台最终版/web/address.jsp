...
<%--							<p class="addp"><a href="#"  id="readd">修改</a><a href="#" id="deladd">删除</a></p>--%>
<%--						</div>--%>
...
<%--						遍历地址--%>
						<c:forEach items="${sessionScope.Slist}" var="s" varStatus="vs">
							<div class="dizhi">
								...
								<p class="addp"><a href="user?method=updateAddress1&ship_id=${s.ship_id}&id=${sessionScope.user.u_id}"  class="update">修改</a><a href="user?method=deleteAddress&ship_id=${s.ship_id}&id=${sessionScope.user.u_id}" class="deladd">删除</a></p>
							</div>
						</c:forEach>
					</div>		
				</div>
